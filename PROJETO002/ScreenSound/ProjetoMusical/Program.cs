...
ep1.AdicionarConvidado ("Jonatas");

Episodio ep2 = new Episodio(1,"Tecnicas de apredizado",55);
ep2.AdicionarConvidado ("Melvim");
ep2.AdicionarConvidado ("Number");
ep2.AdicionarConvidado ("Castelo");
ep2.AdicionarConvidado ("Walter");

Podcast podcast = new("Podcast de Natal","Daniel");
...
// albumQueen.Nome = "The Night at the Opera";

// Musica musica3 = new Musica();
// musica3.NomeMusica = "Love of my life";
// musica3.Duracao = 213;

// Musica  musica4 = new Musica();
// musica4.NomeMusica = "Bohemian Rhapsody";
// musica4.Duracao = 315;

// albumQueen.AdicionarMusica(musica3);
// albumQueen.AdicionarMusica(musica4);
